...
<head>
    <meta charset="UTF-8">
    <title>Ștergere judecători</title>
...
<body class="page-justice">
    ...
    <div class="justice-card" style="width: 420px;">
        ...
        %>
            ...
            <p>
                Nu ai selectat niciun judecător pentru ștergere!
            </p>
        ...
        <%
                ...
                try {
                    jb.connect();
                    jb.stergeDateTabela(s, "Judecatori", "ID_Judecator");
                    jb.disconnect();
        %>
                    ...
                    <p>
                        Judecătorii selectați au fost șterși cu succes!
                    </p>
